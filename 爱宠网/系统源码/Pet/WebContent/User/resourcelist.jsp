    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                ...
                <li>
                    <input type="text" placeholder="请输入introduce" name="introduce" class="input keyText"
                ...
                <volist name="list" id="vo">
                    <tr>
                        <td style="text-align:left; padding-left:20px;">
                            <input type="checkbox" name="checkResource" value="<s:property value="#s.id"/>"/>
                            <s:property value="#s.id"/>
                        </td>
                        <td><s:property value="#s.introduce"/></td>
                        <td>
                            <s:property value="#s.time"/>
                            <%--<s:date name="#s.vedioDate" format="yyyy-MM-dd"/>--%>
                        </td>
                        <td><a href="See.jsp?address=<s:property value='%{#s.downloadUrl}' />">观看</a></td> 
                        <td>
                ...
                <td colspan="7">
                    <div class="pagelist">
                        ...
                        <s:if test="currentPage != 1&&pageSize!=0">
                            <a href="resource_findResourceByCondition.action?currentPage=<s:property value="1"/>">首页</a>
                            <a href="resource_findResourceByCondition.action?currentPage=<s:property value="currentPage-1"/>">
                        ...
                        <s:if test="currentPage != pageSize&&pageSize!=0">
                            ...
                            <a href="resource_findResourceByCondition.action?currentPage=<s:property value="pageSize"/>">尾页</a>
                        </s:if>
...
<script type="text/javascript">
    ...
    function changesearch() {
        document.getElementById("listform").action = "resource_findResourceByCondition1.action";
    ...
    function del(id) {
        if (confirm("您确定要删除这条视频吗?")) {
            ...
            document.getElementById("listform").action = "resource_deleteResource.action";
            document.getElementById("listform").submit();
        }
    }
    ...
    $("#checkall").click(function () {
        $("input[name='checkResource']").each(function () {
            if (this.checked) {
                this.checked = false;
            }
            else {
    ...
    function DelSelect() {
        ...
        if (Checkbox) {
            ...
            document.getElementById("listform").action = "resource_deleteMoreResource.action";
            document.getElementById("listform").submit();
            $("#listform").submit();
        }
        else {
