	...
	<table>
		<tr>
			...
			<td colspan="4" width="55%" class="tocenter"><s:if
				...
				<s:else>
					<a href="/Pet/Manager_getPageList.action?page=1">第一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
					<a
						href="/Pet/Manager_getPageList.action?page=<s:property value="%{page1.currentPage-1}"/>">上一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
				</s:else> <s:if test="%{page1.currentPage != page1.totalPage}">
					<a
						href="/Pet/Manager_getPageList.action?page=<s:property value="%{page1.currentPage+1}"/>">下一页&nbsp;&nbsp;&nbsp;&nbsp;</a>
					<a
						href="/Pet/Manager_getPageList.action?page=<s:property value="page1.totalPage"/>">最后一页</a>
