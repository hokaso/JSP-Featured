...
<body>
	...
	<div class="page-container">
		<h1>Regist</h1>
		<form action="Member_regist.action" method="post">

			<input type="text" name="member.account" class="username"
				placeholder="Account" /> <input type="password" name="member.pwd"
				class="password" placeholder="Password" />
  				<input type="text" name="checkcode" id="checkcodeID" maxlength="4" size="4"placeholder="CheckCode"/>
                ...
                <a href="javascript:void(0)" onClick="change()">看不清，换一个</a>
  				 ...
  				 <span id="show"></span>
  			<input type="email" placeholder="email" name="member.email"/>	
			<button type="submit" id="submit" disabled="true">Regist</button>
