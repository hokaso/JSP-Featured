...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        ...
        <!--修改密码表单-->
        <form method="post" class="form-x" action="Manager_updatePassword.action">
            <div class="form-group">
                ...
                <div class="field">
                    <label style="line-height:33px;">
                       <s:property value="#session.admininfo.id"/>
                        (<s:property value="#session.admininfo.userAuthority"/>)
                    </label>
                </div>
            </div>

            <input type="hidden" name="manager.id" value="<s:property value="#session.admininfo.id" default="0"/>">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="password" class="input w50" name="manager.password" size="50" placeholder="请输入新密码"
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="password" class="input w50" name="renewpass" size="50" placeholder="请再次输入新密码"
                           data-validate="required:请再次输入新密码,repeat#manager.password:两次输入的密码不一致"/>
                </div>
            </div>
