        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                ...
                <if condition="$iscid eq 1">
                    <li>
                        <select name="vedioTypePO.typeId" class="input typeSelect" style="width:200px; line-height:17px;">
                            <option value="0">请选择分类</option>
                            <option value="1">搞笑视频</option>
                            <option value="2">科普视频</option>
                        </select>
                    </li>
                </if>
                <li>
                    <input type="text" placeholder="请输入视频关键词" name="vedioKey" class="input keyText"
                ...
                <volist name="list" id="vo">
                    <tr>
                        <td style="text-align:left; padding-left:20px;">
                            <input type="checkbox" name="checkVedio" value="<s:property value="#s.id"/>"/>
                            <s:property value="#s.id"/>
                        </td>
                        <td><s:property value="#s.vedioTitle"/></td>
                        <td><s:property value="#s.vedioAuthor"/></td>
                        <td><s:property value="#s.vedioKey"/></td>
                        <td><s:property value="#s.vedioTypePO.typeName"/></td>
                        <td>
                            <%--<s:property value="#s.vedioDate"/>--%>
                ...
                <td colspan="7">
                    <div class="pagelist">
                        ...
                        <s:if test="currentPage != 1&&pageSize!=0">
                            <a href="vedio_findVedioByCondition.action?currentPage=<s:property value="1"/>">首页</a>
                            <a href="vedio_findVedioByCondition.action?currentPage=<s:property value="currentPage-1"/>">
                        ...
                        <s:if test="currentPage != pageSize&&pageSize!=0">
                            ...
                            <a href="vedio_findVedioByCondition.action?currentPage=<s:property value="pageSize"/>">尾页</a>
                        </s:if>
...
<script type="text/javascript">
    ...
    function changesearch() {
        document.getElementById("listform").action = "vedio_findVedioByCondition.action";
    ...
    function del(id) {
        if (confirm("您确定要删除这条视频吗?")) {
            ...
            document.getElementById("listform").action = "vedio_deleteVedio.action";
            document.getElementById("listform").submit();
        }
    }
    ...
    $("#checkall").click(function () {
        $("input[name='checkVedio']").each(function () {
            if (this.checked) {
                this.checked = false;
            }
            else {
    ...
    function DelSelect() {
        ...
        if (Checkbox) {
            ...
            document.getElementById("listform").action = "vedio_deleteMoreVedio.action";
            document.getElementById("listform").submit();
            $("#listform").submit();
        }
        else {
