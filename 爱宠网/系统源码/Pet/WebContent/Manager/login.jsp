        ...
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="Manager_login.action" method="post">
                <div class="panel loginbox">
                    <div class="text-center margin-big padding-big-top"><h1>宠物网站管理中心</h1></div>

                    <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                        <div class="form-group">
                            <div class="field field-icon-right">
                                <input type="text" class="input input-big" name="manager.id" placeholder="管理员账号"
                        ...
                        <div class="form-group">
                            <div class="field field-icon-right">
                                <input type="password" class="input input-big" name="manager.password" placeholder="管理员密码"
                        ...
                        <img src="../User/image.jsp" alt="" width="100" height="32" class="passcode"
